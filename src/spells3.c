		...
		switch (realm+1)
		{
			case REALM_LIFE: /* Life */
				...
				switch (spell)
				{
					...
					case 12: sprintf(p, " 損傷:%d", 3 * plev); break;
					case 13: strcpy (p, " 回復:200"); break;
			...
			case REALM_SORCERY: /* Sorcery */
				...
				switch (spell)
				{
					...
					case  3: sprintf(p, " 距離:%d", plev * 5); break;
					case  4: sprintf(p, " 損傷:3d5+%d", plev + orb); break;
					case  7: sprintf(p, " 損傷:%d", 50 + plev * 2); break;

					case  8: strcpy (p, " 期間:20+d20"); break;
					case 11: sprintf(p, " 損傷:%d", 90 + plev * 2); break;
					case 12: strcpy (p, " 期間:25+d30"); break;
					case 13: sprintf(p, " 期間:%d+d%d", plev, plev + 20); break;
					case 15: sprintf(p, " 損傷:%d", 150 + 6 * plev); break;
#else
					case  0: sprintf(p, " dam %dd4", 3 + ((plev - 1) / 5)); break;
					case  1: strcpy (p, " range 10"); break;
					case  3: sprintf(p, " range %d", plev * 5); break;
					case  4: sprintf(p, " dam 3d5+%d", plev + orb); break;
					case  7: sprintf(p, " dam %d", 50 + plev * 2); break;

					case  8: strcpy (p, " dur 20+d20"); break;
					case 11: sprintf(p, " dam %d", 90 + plev * 2); break;
					case 12: strcpy (p, " dur 25+d30"); break;
					case 13: sprintf(p, " dur %d+d%d", plev, plev + 20); break;
					case 15: sprintf(p, " dam %d", 150 + 6 * plev); break;
#endif
				}
				break;
